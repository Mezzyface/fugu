...
- [x] Enemies import + demo — non-code artifact — `game/assets/enemies/` (curated 5-enemy subset of Pixel Frog's Tiny Swords Enemy Pack — Spear Goblin, Torch Goblin, Hex Shaman, Harpoon Shark, Bomb Fish — each with an Idle spritesheet + avatar portrait; demo in `game/scenes/enemies_demo.tscn`; attribution in `game/assets/licenses/tiny-swords-enemy-pack-License.txt`; screenshot under `screenshots/24/`) (#24)
- [x] Prototype Textures graybox fallback — non-code artifact — `game/assets/prototype/` (curated 9-PNG graybox subset from Kenney's CC0 Prototype Textures, the documented fallback for missing sprites/textures; usage note in `game/assets/prototype/README.md`; demo in `game/scenes/prototype_demo.tscn`; attribution in `game/assets/licenses/prototype-textures.md`; screenshot under `screenshots/25/`) (#25)
